...
#include <avr/io.h>         // AVR device-specific IO definitions			// knihovna popisující výstupy
...
int main(void)
{
    ...
    DDRB = DDRB | (1<<LED_GREEN);											// << je binární shift doleva, | je logický souèet OR 

    // Set pin LOW in Data Register (LED off)
    // PORTB = PORTB and 1101 1111
    PORTB = PORTB & ~(1<<LED_GREEN);										// & je logický souèin AND, ~ je negace
